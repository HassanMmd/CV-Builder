...
function nav(){
    setIsClicked(true);
    navigate("/Languages/EditLanguages", {replace:true});
}
    ...
    return(
           ...
           {!isClicked &&  <div className="delete-edit">
            ...
            <div className="card-body">
              ...
              <h6 className="card-subtitle mb-2 text-muted">{levelList[props.info.level]}</h6>
          </div>
          {isClicked && <Routes>
                <Route path="EditLanguages" element={<EditLanguage info={props.info} />}></Route>
            </Routes>}
          </div>
