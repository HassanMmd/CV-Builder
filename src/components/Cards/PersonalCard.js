...
function Card(props) {
    ...
    function nav(){
        setIsClicked(true);
        navigate("/PersonalInfo/EditPersonal", {replace:true});
    }
        ...
        return (
           ...
           {!isClicked &&  <div className="delete-edit">
                ...
                <div className="card-body">
                    ...
                    <h6 className="card-subtitle mb-2 text-muted">{props.information.role}</h6>
                    <p className="card-text">{props.information.brief}</p>
                </div>
                {isClicked && <Routes>
                <Route path="EditPersonal" element={<EditPersonal info={props.information} />}></Route>
            </Routes>}
            </div>
